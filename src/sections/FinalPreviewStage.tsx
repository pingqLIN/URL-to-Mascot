        ...
        {showWaitingState ? (
          ...
          >
            ...
            <div className="text-center">
              <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-amber-300/72">
                {t('workflowStepPreview')}
              </p>
              <p className="mt-3 text-sm font-semibold text-white/86">{t('generating')}</p>
            </div>
          </motion.div>
        ) : (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.55, ease: STANDARD_EASE }}
